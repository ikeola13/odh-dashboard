...
import type { UserAuthConfig, TestConfig, AWSS3BucketDetails, AWSS3Buckets } from '../types';
...
[
  ...
  dotenv.config({
    path: path.resolve(__dirname, '../../../../frontend', file),
  }),
);
...
const LDAP_CLUSTER_ADMIN_USER: UserAuthConfig = testConfig?.TEST_USER_5 ?? {
